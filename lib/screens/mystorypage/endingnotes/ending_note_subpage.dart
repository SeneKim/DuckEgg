...
class EndingNoteSub extends StatefulWidget {
  const EndingNoteSub({super.key});

  @override
  State<EndingNoteSub> createState() => _EndingNoteSubState();
}

class _EndingNoteSubState extends State<EndingNoteSub> {
  ...
  _loadText() async {
    ...
    String? savedText = prefs.getString('toDaughter');
    inputController.text = savedText!;
  }

  _saveText(String text) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString('toDaughter', text);
  }
