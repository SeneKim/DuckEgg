...
import 'package:hummingbird/screens/settingpage/putting_voice.dart';
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: const DecorationImage(
                                  image: AssetImage(
                                      'assets/images/userimage_setting.png'),
                                  fit: BoxFit.fill)),
                        ),
                        const Text(
                          '김 남 길',
                                ...
                                child: Container(
                                  ...
                                  decoration: const BoxDecoration(
                                    image: DecorationImage(
                                        image: AssetImage(
                                            "assets/images/setting_button1.png"),
                                        fit: BoxFit.contain),
                                  ),
                                ),
                              ),
...
void toPutVoice(BuildContext context) {
  Navigator.push(
      context, MaterialPageRoute(builder: (context) => const PutVoice()));
}
...
void toMikeTest(BuildContext context) {
  Navigator.push(
      context, MaterialPageRoute(builder: (context) => const MikeTest()));
}
